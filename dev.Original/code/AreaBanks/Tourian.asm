...
L9825:	LDA $77F6,Y
L9828:	PHA 
L9829:	LDA EnVertSpeed,X
L982C:	BPL $983B
L982E:	PLA 
L982F:	JSR TwosCompliment_
L9832:	PHA 
L9833:	LDA #$00
L9835:	CMP $0406,X
L9838:	SBC EnVertSpeed,X
L983B:	CMP $77F6,Y
L983E:	PLA 
L983F:	BCC $9849
L9841:	STA EnVertSpeed,X
L9844:	LDA #$00
L9846:	STA $0406,X
L9849:	LDA $77F6,Y
L984C:	PHA 
...
L9950:	PLP 
L9951:	BMI $9956
L9953:	JSR TwosCompliment_
L9956:	STA $05
L9958:	JSR $99E4
L995B:	JSR CallCalcPotentialPosition
L995E:	JSR $99F4
L9961:	JMP $9967
L9964:	JSR $99AE
L9967:	LDA $6AF4,X
...
L9AA5:	STA $0406,X
L9AA8:	LDA #$00
L9AAA:	SBC EnVertSpeed,X
L9AAD:	STA EnVertSpeed,X
L9AB0:	LDA $0405,X
L9AB3:	ASL 
L9AB4:	BMI $9AF4
L9AB6:	LDA $0406,X
...
L9AE2:	LDA $6AFB,X
L9AE5:	STA $0B
L9AE7:	JSR CallCalcPotentialPosition
L9AEA:	BCS $9AF1
L9AEC:	LDA #$00
L9AEE:	STA $6AF4,X
L9AF1:	JSR $99F4
...
L9C1D:	TYA 
L9C1E:	TAX 
L9C1F:	JSR CallCalcPotentialPosition
L9C22:	JSR $99F4
L9C25:	LDX $97
L9C27:	RTS
