...
L9925:	CMP #$03
L9927:	BEQ $992C
L9929:	JSR CallUpdateHomeRelativeAnimation
L992C:	LDA #$06
L992E:	STA $00
L9930:	LDA #$08
L9932:	STA $01
...
L993F:	CMP #$03
L9941:	BEQ $9946
L9943:	JSR CallUpdateEnAnimationDirection
L9946:	JMP $992C
L9949:	LDA $81
L994B:	CMP #$01
L994D:	BEQ $9993
...
L9995:	JMP $8003
L9998:	JMP $8006
L999B:	JSR GetRandom_EnIdxFrCnt
L999E:	AND #$03
L99A0:	BEQ $99D6
L99A2:	LDA $81
L99A4:	CMP #$01
...
L9A62:	STA $6AFE,X
L9A65:	BNE $9A83
L9A67:	LDA EnVertSpeed,X
L9A6A:	BMI $9A83
L9A6C:	LDA #$00
L9A6E:	STA EnVertSpeed,X
L9A71:	STA $0406,X
L9A74:	STA $6AFE,X
L9A77:	LDA $0405,X
L9A7A:	AND #$01
...
L9A8C:	CMP #$02
L9A8E:	BNE $9AA7
L9A90:	JSR CallEnVerticalAcceleration
L9A93:	PHA 
L9A94:	JSR CallEnHorizontalAcceleration
L9A97:	STA $05
L9A99:	PLA 
L9A9A:	STA $04
L9A9C:	JSR $9BBC
L9A9F:	JSR CallCalcPotentialPosition
L9AA2:	BCC $9AAC
L9AA4:	JSR $9BAA
L9AA7:	LDA #$03
L9AA9:	JMP $8003
...
L9B02:	CMP #$02
L9B04:	BNE $9B24
L9B06:	JSR CallGetEnVerticalVelocity
L9B09:	LDX $4B
L9B0B:	LDA $00
L9B0D:	STA EnVertSpeed,X
L9B10:	JSR CallGetEnVerticalVelocity
L9B13:	LDX $4B
L9B15:	LDA $00
L9B17:	STA $0403,X
L9B1A:	JSR CallEnemyBGCrashDetection
L9B1D:	BCS $9B24
L9B1F:	LDA #$03
L9B21:	STA $6AF4,X
L9B24:	LDA #$01
L9B26:	JSR CallUpdateEnemyAnim
L9B29:	JMP $8006
L9B2C:	JMP $9AE4
L9B2F:	LDX #$50
L9B31:	JSR $9B3C
...
L9B9B:	PLA 
L9B9C:	TAX 
L9B9D:	JSR CallCalcPotentialPosition
L9BA0:	BCC $9BBB
L9BA2:	LDA $6AF4,X
L9BA5:	BNE $9BAA
L9BA7:	INC $6AF4,X
