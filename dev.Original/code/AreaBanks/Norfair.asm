...
L986E:	STA $6AFE,X
L9871:	BNE $988F
L9873:	LDA EnVertSpeed,X
L9876:	BMI $988F
L9878:	LDA #$00
L987A:	STA EnVertSpeed,X
L987D:	STA $0406,X
L9880:	STA $6AFE,X
L9883:	LDA $0405,X
L9886:	AND #$01
...
L9898:	CMP #$02
L989A:	BNE $98B3
L989C:	JSR CallEnVerticalAcceleration
L989F:	PHA 
L98A0:	JSR CallEnHorizontalAcceleration
L98A3:	STA $05
L98A5:	PLA 
L98A6:	STA $04
L98A8:	JSR $9A42
L98AB:	JSR CallCalcPotentialPosition
L98AE:	BCC $98B8
L98B0:	JSR $9A52
L98B3:	LDA #$03
L98B5:	JMP $8003
...
L98C3:	CMP #$03
L98C5:	BEQ $98CA
L98C7:	JSR CallUpdateEnAnimationDirection
L98CA:	LDA #$03
L98CC:	STA $00
L98CE:	STA $01
L98D0:	JMP $9839
...
L9957:	LDA $040B,X
L995A:	PHA 
L995B:	JSR CallResetEnemy
L995E:	PLA 
L995F:	STA $040B,X
L9962:	RTS

L9963:	JSR CallUpdateHomeRelativeAnimation
L9966:	LDA #$06
L9968:	STA $00
L996A:	JMP $9839
L996D:	JSR CallUpdateHomeRelativeAnimation
L9970:	LDA #$06
L9972:	STA $00
L9974:	JMP $9839
L9977:	JSR CallUpdateHomeRelativeAnimation
L997A:	LDA #$06
L997C:	STA $00
L997E:	LDA $81
L9980:	CMP #$02
...
L9984:	CMP $6AF4,X
L9987:	BNE $9993
L9989:	JSR GetRandom_EnIdxFrCnt
L998C:	AND #$03
L998E:	BNE $9993
L9990:	JMP $984D
L9993:	JMP $9839
L9996:	JSR GetRandom_EnIdxFrCnt
L9999:	AND #$03
L999B:	BEQ $99D1
L999D:	LDA $81
L999F:	CMP #$01
...
L9A95:	CMP #$03
L9A97:	BEQ $9ACF
L9A99:	JSR CallEnVerticalAcceleration
L9A9C:	LDX $4B
L9A9E:	LDA #$00
L9AA0:	STA $05
L9AA2:	LDA #$1D
...
L9AAC:	STA $6AF9,X
L9AAF:	JSR $9A42
L9AB2:	JSR CallCalcPotentialPosition
L9AB5:	LDA #$E8
L9AB7:	BCC $9ABD
L9AB9:	CMP $08
L9ABB:	BCS $9AC7
...
L9AD9:	CMP #$02
L9ADB:	BNE $9AE0
L9ADD:	JSR CallUpdateEnAnimationDirection
L9AE0:	LDA #$02
L9AE2:	STA $00
L9AE4:	STA $01
L9AE6:	JMP $9839
...
L9B45:	TAY 
L9B46:	LDA $9B62,Y
L9B49:	JSR CallResetAnimIndex
L9B4C:	JMP $9B59
L9B4F:	LDA $6AF4,X
L9B52:	CMP #$03
L9B54:	BEQ $9B59
L9B56:	JSR CallUpdateEnAnimationDirection
L9B59:	LDA #$01
L9B5B:	STA $00
L9B5D:	STA $01
L9B5F:	JMP $9839
