...
L9850:	CMP #$03
L9852:	BEQ $9857
L9854:	JSR CallUpdateHomeRelativeAnimation
L9857:	LDA #$06
L9859:	STA $00
L985B:	LDA #$08
L985D:	STA $01
...
L9885:	STA $6AFE,X
L9888:	BNE $98A6
L988A:	LDA EnVertSpeed,X
L988D:	BMI $98A6
L988F:	LDA #$00
L9891:	STA EnVertSpeed,X
L9894:	STA $0406,X
L9897:	STA $6AFE,X
L989A:	LDA $0405,X
L989D:	AND #$01
...
L98BD:	STA $04
L98BF:	JSR $9AE1
L98C2:	JSR CallCalcPotentialPosition
L98C5:	BCC $98CF
L98C7:	JSR $9AF1
L98CA:	LDA #$03
L98CC:	JMP $8003
...
L9967:	JSR GetRandom_EnIdxFrCnt
L996A:	AND #$03
L996C:	BEQ $99A2
L996E:	LDA $81
L9970:	CMP #$01
...
L9A37:	LDA #$0E
L9A39:	STA $86
L9A3B:	JSR CallUpdateHomeRelativeAnimation
L9A3E:	JSR $9A79
L9A41:	LDA #$03
L9A43:	STA $00
L9A45:	STA $01
...
L9AC1:	LDA #$F8
L9AC3:	STA $04
L9AC5:	JSR CallCalcPotentialPosition
L9AC8:	BCC $9AA9
L9ACA:	LDA #$00
L9ACC:	STA $040F,X
L9ACF:	LDA #$0A
...
L9B06:	CMP #$02
L9B08:	BNE $9B0D
L9B0A:	JSR CallUpdateEnAnimationDirection
L9B0D:	LDA #$02
L9B0F:	STA $00
L9B11:	STA $01
L9B13:	JMP $9830
