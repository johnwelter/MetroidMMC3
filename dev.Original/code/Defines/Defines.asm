...
.alias DoorWRAMPos			$5C ;lo byte of door data = yyyx xxxx
;							$5D ;hi byte of door data = 0110 0nyy 
...
;0366/7 something to do with door stuff
;0387 something to do with door stuff
;038A something to do with door stuff
;0380 - door statuses
; 0 = inactive
; 1 = ?
; 2 = closed
